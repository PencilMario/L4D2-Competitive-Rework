...
public void OnPluginStart()
{
	...
	g_hSpawnType = CreateConVar("l4d2_mitsr_spawn_type", "0", "0 = Custom list, 1 = Random Weapon and 2 = Map based weapons.", _, true, 0.0, true, 2.0);
	...
	g_hMeleeItems[1] = CreateConVar("l4d2_mitsr_fryingpan", "0", "Number of frying pans to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[2] = CreateConVar("l4d2_mitsr_machete", "0", "Number of machetes to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[3] = CreateConVar("l4d2_mitsr_baseballbat", "0", "Number of baseball bats to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[4] = CreateConVar("l4d2_mitsr_crowbar", "0", "Number of crowbars to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[5] = CreateConVar("l4d2_mitsr_cricketbat", "0", "Number of cricket bats to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	...
	g_hMeleeItems[7] = CreateConVar("l4d2_mitsr_katana", "0", "Number of katanas to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[8] = CreateConVar("l4d2_mitsr_elecguitar", "0", "Number of electric guitars to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[9] = CreateConVar("l4d2_mitsr_knife", "0", "Number of knifes to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[10] = CreateConVar("l4d2_mitsr_golfclub", "0", "Number of golf clubs to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[11] = CreateConVar("l4d2_mitsr_shovel", "0", "Number of shovels to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[12] = CreateConVar("l4d2_mitsr_pitchfork", "0", "Number of pitchforks to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
	g_hMeleeItems[13] = CreateConVar("l4d2_mitsr_riotshield", "0", "Number of tonfas to spawn (l4d2_mitsr_spawn_type must be 0)", _, true, 0.0, true, 10.0);
